defmodule Cards do
  @moduledoc """
    Provided methods for creating and handling a deck of cards
  """
  ...
  def save(deck, filename) do
    binary = :erlang.term_to_binary(deck) # converts a file to something that can be saved
  ...
  def load(filename) do 
    case File.read(filename) do 
      ...
      {:error, _} -> "That file doesn not exist"
    end
  end
